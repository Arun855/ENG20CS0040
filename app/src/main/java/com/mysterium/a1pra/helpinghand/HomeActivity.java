...
public class HomeActivity extends AppCompatActivity {
	...
	TextView welcomeTv;
	Button notes, reminder, expenses, blog;
	ImageButton popupB;
	String username;
	String password;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		blog.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(HomeActivity.this, com.mysterium.a1pra.helpinghand.myblog.MyBlogActivity.class);
				startActivity(intent);
				finish();
